...
plot data_dir.file_name.".txt" \
    using 2:xtic(1) t '{/Helvetica=28 gamma=0}' fs pattern 2 ls 1, \
    '' using 3 t '{/Helvetica=28 gamma=1}' fs pattern 3 ls 2, \
    '' using 4 t '{/Helvetica=28 gamma=10}' fs pattern 4 ls 3

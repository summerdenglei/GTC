...
%%     
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [sigma] = analyze_temporal(input_TM_dir, filename, num_frames, width, height, itvls, num_anomaly, sigma_mag)
    ...
    for itvl = itvls
        ...
        output_file = [output_dir filename '.na' num2str(num_anomaly) '.anom' num2str(sigma_mag) '.itvl' num2str(itvl) '.diff.txt'];
        dlmwrite(output_file, [x, f], 'delimiter', '\t');

...
%%     
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [sigma] = analyze_low_rank_2d_interp(input_TM_dir, filename, num_frames, width, height, thresh, num_anomaly, sigma_mag)
    ...
    %% interpolation
    x = [0:0.01:1]';
    y = interp1(k, cdf, x,'spline');

    output_file = [output_dir filename '.na' num2str(num_anomaly) '.anom' num2str(sigma_mag) '.cdf.poly.txt'];
    dlmwrite(output_file, [x, y], 'delimiter', '\t');

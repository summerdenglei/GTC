...
plot data_dir."tm_abilene.od..".param.".cdf.txt" using 1:2 with lines ls 1 title '{/Helvetica=28 Abilene}', \
     data_dir."tm_totem..".param.".cdf.txt"      using 1:2 with lines ls 2 title '{/Helvetica=28 GEANT}', \
     data_dir."tm_3g.cell.bs.bs3.all.bin10.txt.".param.".cdf.txt" using 1:2 with lines ls 3 title '{/Helvetica=28 3G}', \
     data_dir."tm_sjtu_wifi.ap_load.all.bin600.top50.txt.".param.".cdf.txt" using 1:2 with lines ls 4 title '{/Helvetica=28 WiFi}', \
     data_dir."tm_ron1.latency..".param.".cdf.txt" using 1:2 with lines ls 8 title '{/Helvetica=28 RON}'

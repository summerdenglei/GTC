...
set key right bottom samplen 1.5 width -1
...
set style line 5 lc rgb "#FFD800" lt 1 lw 2 pt 5 ps 1.5 pi -1  ## solid box
...
plot data_dir."tm_3g.cell.bs.bs3.all.bin10.txt.".param.".cdf.txt" using 1:2 with lines ls 3 title '{/Helvetica=20 3G}', \
     data_dir."tm_sjtu_wifi.ap_load.all.bin600.top50.txt.".param.".cdf.txt" using 1:2 with lines ls 4 title '{/Helvetica=20 WiFi}', \
     data_dir."tm_abilene.od..".param.".cdf.txt" using 1:2 with lines ls 1 title '{/Helvetica=20 Abilene}', \
     data_dir."tm_totem..".param.".cdf.txt"      using 1:2 with lines ls 2 title '{/Helvetica=20 GEANT}', \
     data_dir."Mob-Recv1run1.dat0_matrix.mat_dB.txt.".param.".cdf.txt" using 1:2 with lines ls 5 title '{/Helvetica=20 CSI (1 shannel)}', \
     data_dir."static_trace13.ant1.mag.txt.".param.".cdf.txt" using 1:2 with lines ls 9 title '{/Helvetica=20 CSI (multi-channel)}', \
     data_dir."tm_telos_rssi.txt.".param.".cdf.txt" using 1:2 with lines ls 6 title '{/Helvetica=20 Cister RSSI}', \
     data_dir."tm_multi_loc_rssi.txt.".param.".cdf.txt" using 1:2 with lines ls 7 title '{/Helvetica=20 CU RSSI}', \
     data_dir."tm_umich_rss.txt.".param.".cdf.txt" using 1:2 with lines ls 11 title '{/Helvetica=20 UMich RSS}', \
     data_dir."tm_ucsb_meshnet.connected.txt.".param.".cdf.txt" using 1:2 with lines ls 10 title '{/Helvetica=20 UCSB Meshnet}' #, \
     # data_dir."tm_ron1.latency..".param.".cdf.txt" using 1:2 with lines ls 8 title '{/Helvetica=20 RON delay}'

...
plot [:0.001][0:0.001] \
     x+100 with linespoints ls 1 title '{/Helvetica=28 SVD Base}', \
     x+100 with linespoints ls 2 title '{/Helvetica=28 SVD Base+KNN}', \
     x+100 with linespoints ls 3 title '{/Helvetica=28 SRMF}', \
     x+100 with linespoints ls 4 title '{/Helvetica=28 SRMF+KNN}', \
     x+100 with linespoints ls 5 title '{/Helvetica=28 LENS}'
     #x+100 with linespoints ls 6 title '{/Helvetica=28 LENS+KNN}', \
     #x+100 with linespoints ls 7 title '{/Helvetica=28 LENS+SRMF+KNN}'

...
set ylabel '{/Helvetica=28 Y_LABEL}' offset character 0, 0, 0
...
set style line 1 lc rgb "red"     lt 1 lw 5 pt 1 ps 1.0 pi -1  ## +
set style line 2 lc rgb "blue"    lt 2 lw 5 pt 2 ps 1.0 pi -1  ## x
set style line 3 lc rgb "#00CC00" lt 5 lw 5 pt 3 ps 1.0 pi -1  ## *
set style line 4 lc rgb "#7F171F" lt 4 lw 5 pt 4 ps 1.0 pi -1  ## box
set style line 5 lc rgb "#FFD800" lt 3 lw 5 pt 5 ps 1.0 pi -1  ## solid box
set style line 6 lc rgb "#000078" lt 6 lw 5 pt 6 ps 1.0 pi -1  ## circle
set style line 7 lc rgb "#732C7B" lt 7 lw 5 pt 7 ps 1.0 pi -1
set style line 8 lc rgb "black"   lt 8 lw 5 pt 8 ps 1.0 pi -1  ## triangle
set style line 9 lc rgb "red"     lt 9 lw 5 pt 9 ps 1.0 pi -1

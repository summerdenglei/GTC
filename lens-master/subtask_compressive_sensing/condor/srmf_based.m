...
%%
%% e.g. 
%%     [tp, tn, fp, fn, precision, recall, f1score] = srmf_based('/u/yichao/anomaly_compression/condor_data/subtask_inject_error/TM_err/', 'TM_Airport_period5_.exp0.', 12, 300, 300, 4, 5, 50, 0, 1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

...
# set y2label '{/Helvetica=28 Y2_LABEL}' offset character -2, 0, 0
...
#set style line 1 lc rgb "#e41a1c"  lt 1 lw 5 pt 6 ps 3 pi -1  ## +
set style line 1 lc rgb "blue"  lt 1 lw 5 pt 6 ps 3 pi -1  ## +
...
set style line 13 lc rgb "blue"  lt 3 lw 0 pt 9 ps 3 pi -1  ## +

...
function [mse, mae, cc, ratio, tp, tn, fp, fn, precision, recall, f1score, jaccard, normalized_y, y_val, best_thresh] = srmf_based_pred(input_TM_dir, filename, num_frames, width, height, group_size, r, period, option_swap_mat, option_type, option_dim, drop_ele_mode, drop_mode, elem_frac, loss_rate, burst_size, num_anomaly, sigma_magnitude, sigma_noise, thresh, seed, param1, param2, param3)

...
%%
%% e.g. 
%%     lens_dect('../condor_data/subtask_parse_abilene/tm/', 'tm_abilene.od.', 1008, 11, 11, 8, 5, 1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function lens_dect(input_TM_dir, filename, num_frames, width, height, r, thresh, seed)
    ...
    output_dir = '../processed_data/subtask_compressive_sensing/dect_anomaly/';

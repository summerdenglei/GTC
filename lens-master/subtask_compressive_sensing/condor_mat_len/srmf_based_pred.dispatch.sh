...
for filename in ${files[@]}; do
    ...
    if [[ ${filename} == "tm_3g.cell.bs.bs3.all.bin10.txt" ]]; then
        ...
        # num_frames=144
        # num_frames=144
        # num_framess=(50 70 90 110 130 144)
    ...
    if [[ ${filename} == "tm_totem." ]]; then
        ...
        # num_frames=100
        # num_frames=672
        # num_framess=(200 300 400 500 600 672)
    ...
    if [[ ${filename} == "tm_abilene.od." ]]; then
        ...
        # num_frames=100
        # num_frames=1008
        # num_framess=(500 600 700 800 900 1008)
    ...
    if [[ ${filename} == "Mob-Recv1run1.dat0_matrix.mat_dB.txt" ]]; then
        ...
        # num_frames=1000
        # num_framess=(500 600 700 800 900 1000)
    ...
    for seed in ${seeds[@]}; do
        ...
        for num_frames in ${num_framess[@]}; do

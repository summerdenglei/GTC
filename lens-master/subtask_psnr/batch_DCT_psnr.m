...
for group_size = group_sizes
    for num_chunks = max_chunks
        ...
        [psnr, compressed_ratio] = DCT_psnr(num_chunks, group_size, video, 90, 352, 288);
...
for group_size = group_sizes
    for num_chunks = max_chunks
        video = 'bus_cif.yuv';
        [psnr, compressed_ratio] = DCT_psnr(num_chunks, group_size, video, 150, 352, 288);
        fprintf('%s, %d, %d, %f, %f\n', video, num_chunks, group_size, compressed_ratio, psnr);
        fprintf(fh, '%s, %d, %d, %f, %f\n', video, num_chunks, group_size, compressed_ratio, psnr);
    end
end
...
for group_size = group_sizes
    for num_chunks = max_chunks
        ...
        [psnr, compressed_ratio] = DCT_psnr(num_chunks, group_size, video, 300, 352, 288);
        fprintf('%s, %d, %d, %f, %f\n', video, num_chunks, group_size, compressed_ratio, psnr);
        fprintf(fh, '%s, %d, %d, %f, %f\n', video, num_chunks, group_size, compressed_ratio, psnr);
    end
end

...
function [psnr_srmf, compressed_ratio_srmf, psnr_base, compressed_ratio_base] = compressive_sensing_psnr(r, group_size, video_name, frames, width, height)
    ...
    %  save file
    %% --------------------
    saveFileYuv2(compressed_mov, [output_dir video_name '.comp_sen.' int2str(group_size) '.' int2str(r) '.' int2str(video.frames) '.' int2str(video.width) '.' int2str(video.height) '.yuv'], 'w');

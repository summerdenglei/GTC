...
file_name = ""
fig_name  = "corrcoef_dist_rank.bin60"
...
data_dir."corrcoef_dist_rank.dl.bin60.txt" using 1:2 with linespoints ls 2 title '{/Helvetica=28 Downlink}', \
data_dir."corrcoef_dist_rank.ul.bin60.txt" using 1:2 with linespoints ls 3 title '{/Helvetica=28 Uplink}'
...
fig_dir  = "../processed_data/subtask_analyze_3g/stat/figures/"
file_name = ""
fig_name  = "corrcoef_dist_rank.bin10"
set output fig_dir.fig_name.".eps"
...
set xtics rotate by 0
# set format x "10^{%L}"
# set xtics ("Same BS" 0, "1km" 1, "5km" 2, "10km" 3, "20km" 4, "30km" 5, "50km" 6)
...
data_dir."corrcoef_dist_rank.dl.bin10.txt" using 1:2 with linespoints ls 2 title '{/Helvetica=28 Downlink}', \
data_dir."corrcoef_dist_rank.ul.bin10.txt" using 1:2 with linespoints ls 3 title '{/Helvetica=28 Uplink}'

...
file_name = "load_cdf.all"
fig_name  = "load_cdf.all"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 Network Load (bytes)}'
set ylabel '{/Helvetica=28 CDF}'
...
plot data_dir.file_name.".txt" using 2:1 with lines ls 1 title '{/Helvetica=28 all day}', \
     data_dir.file_name.".day.txt" using 2:1 with lines ls 2 title '{/Helvetica=28 day time}', \
     data_dir.file_name.".night.txt" using 2:1 with lines ls 3 title '{/Helvetica=28 night time}'
...
data_dir = "../processed_data/subtask_analyze_3g/stat/"
fig_dir  = "../processed_data/subtask_analyze_3g/stat/figures/"
file_name = "load_cdf.dl"
fig_name  = "load_cdf.dl"
set output fig_dir.fig_name.".eps"
...
data_dir = "../processed_data/subtask_analyze_3g/stat/"
fig_dir  = "../processed_data/subtask_analyze_3g/stat/figures/"
file_name = "load_cdf.ul"
fig_name  = "load_cdf.ul"
set output fig_dir.fig_name.".eps"

function [X,Y,TC,TotalRes,TrueRel,truerel] = TCTF_ST_solver_dct(Oridata,B,data,known,Nway,coreNway,opts)
...
TC=rand(Nway);
TC(known)=data;
TC=tensorDCT(TC);%频域C 第一slice为实数，其他为复数 为什么？
